...
if __name__ == "__main__":
    ...
    # day 24
    connection_instance.download_file("https://adventofcode.com/2023/day/24/input", "day_24.txt")
    # day 25
    connection_instance.download_file("https://adventofcode.com/2023/day/25/input", "day_25.txt")